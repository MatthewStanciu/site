      ...
      <SmallerWrapper>
        <CenteredBox>
          <Box width={[350, 500]}>
            ...
            <Project width={[350, 500]} href="#" title="Star City Hacks Organizer" desc="Star City Hacks is an upcoming high school hackathon aiming to strengthen the local coding community among the amazingly bright students in Lafayette, Indiana. March 23rd, 2019" />
            <Project width={[350, 500]} href="https://hackpenn.com" title="Hack Pennsylvania Community and Marketing" desc="Hack Pennsylvania is an upcoming high school hackathon for students across the Northeast. I'm working on marketing and outreach for the event." />
