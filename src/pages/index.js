      ...
      <SmallerWrapper>
        <CenteredBox>
          <Box width={[350, 500]}>
            ...
            <Project width={[350, 500]} href="https://codeday.org/indy" title="CodeDay Indy Regional Manager" desc="CodeDay is a fun, nationwide hackathon aimed toward beginners that strengthens local communities and gets students interested in coding. I am the regional manager for Indianapolis." />
